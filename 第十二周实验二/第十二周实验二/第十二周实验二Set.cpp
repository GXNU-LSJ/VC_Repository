...
// 第十二周实验二Set.cpp : C第十二周实验二Set 类的实现
//
...
// 代码生成在 2020年5月18日, 11:24

IMPLEMENT_DYNAMIC(C第十二周实验二Set, CRecordset)

C第十二周实验二Set::C第十二周实验二Set(CDatabase* pdb)
	: CRecordset(pdb)
{
	m_ID = 0;
	column1 = L"";
...
// 储为其他格式或使用其他的用户身份验证。
CString C第十二周实验二Set::GetDefaultConnect()
{
...
CString C第十二周实验二Set::GetDefaultSQL()
{
	return _T("[学生信息管理系统]");
}

void C第十二周实验二Set::DoFieldExchange(CFieldExchange* pFX)
{
...
#ifdef _DEBUG
void C第十二周实验二Set::AssertValid() const
{
	CRecordset::AssertValid();
}

void C第十二周实验二Set::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
